...
public class CustomDialog6 extends Dialog {
    ...
    public CustomDialog6(Context context, int theme) {
        super(context, theme);
        mContext = context;
    }

    public CustomDialog6 (Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.custom_dialog6, null);
