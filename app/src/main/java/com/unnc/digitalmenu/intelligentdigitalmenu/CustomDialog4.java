...
public class CustomDialog4 extends Dialog {
    ...
    public CustomDialog4(Context context, int theme) {
        super(context, theme);
        mContext = context;
    }

    public CustomDialog4 (Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.custom_dialog4, null);
