...
public class CustomDialog8 extends Dialog {
    ...
    public CustomDialog8(Context context, int theme) {
        super(context, theme);
        mContext = context;
    }

    public CustomDialog8 (Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.custom_dialog8, null);
