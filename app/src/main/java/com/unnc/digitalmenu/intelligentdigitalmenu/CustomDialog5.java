...
public class CustomDialog5 extends Dialog {
    ...
    public CustomDialog5(Context context, int theme) {
        super(context, theme);
        mContext = context;
    }

    public CustomDialog5 (Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.custom_dialog5, null);
