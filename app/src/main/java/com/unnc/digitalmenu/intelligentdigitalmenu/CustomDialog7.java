...
public class CustomDialog7 extends Dialog {
    ...
    public CustomDialog7(Context context, int theme) {
        super(context, theme);
        mContext = context;
    }

    public CustomDialog7 (Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.custom_dialog7, null);
