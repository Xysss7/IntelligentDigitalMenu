...
public class CustomerRepo {
    ...
    public int insert(Customer customer){
        ...
        values.put(Customer.KEY_age,customer.age);
        values.put(Customer.KEY_email,customer.email);
        values.put(Customer.KEY_name,customer.name);
        //
    ...
    public ArrayList<HashMap<String, String>> getCustomerList(){
        ...
        String selectQuery="SELECT "+
                ...
                Customer.KEY_name+","+
                Customer.KEY_email+","+
                Customer.KEY_age+" FROM "+Customer.TABLE;
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                customer.put("name",cursor.getString(cursor.getColumnIndex(Customer.KEY_name)));
    ...
    public Customer getCustomerById(int Id){
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                customer.name =cursor.getString(cursor.getColumnIndex(Customer.KEY_name));
                customer.email  =cursor.getString(cursor.getColumnIndex(Customer.KEY_email));
                customer.age =cursor.getInt(cursor.getColumnIndex(Customer.KEY_age));
            }while(cursor.moveToNext());
        }
        cursor.close();
        db.close();
